  ...
  return (
    <Html lang="en">
      ...
      <body>
        ...
        <meta property="og:description" content="Boost your efficiency with hotkeys and AI." />
        ...
        <meta name="twitter:description" content="Boost your efficiency with hotkeys and AI." />
